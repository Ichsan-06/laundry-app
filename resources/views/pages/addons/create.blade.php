...
@section('title', 'Add New Add-On - Laundry Track')
...
<div class="mx-auto max-w-2xl pb-10">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-slate-900">Add New Add-On</h2>
            <p class="text-sm font-medium text-slate-400">Create a new additional service or product</p>
        </div>
    ...
    <div class="rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-slate-100">
        <form action="{{ route('addons.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="nama" required placeholder="e.g. Parfume Premium, Plastic Bag" value="{{ old('nama') }}" class="block w-full rounded-2xl border-slate-100 bg-slate-50 py-3.5 px-4 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary-500/20">
            ...
            <div class="space-y-2">
                ...
                <input type="number" name="harga" required placeholder="5000" value="{{ old('harga') }}" class="block w-full rounded-2xl border-slate-100 bg-slate-50 py-3.5 px-4 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary-500/20">
